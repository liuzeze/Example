 ...
 */
public class FeBusUtils {

    private static final Object NULL = "nULl";
    private static final String TAG = "FeBusUtils";
     ...
     * by function of {@link FeBusUtils#registerBus} when execute transform task.
     */
    ...
    public String toString() {
        return "FeBusUtils: " + mTag_BusInfoMap;
    }

    private static FeBusUtils getInstance() {
    ...
    private static class LazyHolder {
        private static final FeBusUtils INSTANCE = new FeBusUtils();
    }
}