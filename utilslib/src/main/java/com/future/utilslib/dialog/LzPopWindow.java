...
/**
 * -----------作者----------日期----------变更内容-----
 * -          刘泽      2018-11-12       公共的popwindow
 */
public class LzPopWindow implements PopupWindow.OnDismissListener {
    private static final String TAG = "LzPopWindow";
    ...
    private LzPopWindow(Context context) {
        mContext = context;
    }
     ...
     * @return
     */
    public LzPopWindow showAsDropDown(View anchor, int xOff, int yOff) {
    ...
    public LzPopWindow showAsDropDown(View anchor) {
        if (mPopupWindow != null) {
    ...
    public LzPopWindow showAsDropDown(View anchor, int xOff, int yOff, int gravity) {
        if (mPopupWindow != null) {
     ...
     * @return
     */
    public LzPopWindow showAtLocation(View parent, int gravity, int x, int y) {
        if (mPopupWindow != null) {
    ...
    public static class PopupWindowBuilder {
        private LzPopWindow mCustomPopWindow;

        public PopupWindowBuilder(Context context) {
            mCustomPopWindow = new LzPopWindow(context);
        }
